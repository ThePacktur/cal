...
class Calculadora4(CalculadoraBase):
    ...
    def crear_botones(self, botones):
        ...
        for boton in botones:
            ...
            if col_val > 3:
                col_val = 0
                row_val += 1
        tk.Button(self.root, text='CLR', padx=20, pady=20, font=("Arial", 18), command=self.limpiar_entrada).grid(row=row_val, column=0, columnspan=4)
